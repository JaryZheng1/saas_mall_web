    ...
    <el-row :gutter="20">
      ...
      <el-col :xs="24" :sm="24" :md="24" :lg="6" >
        <el-card :bordered="false" dis-hover class="ivu-mt">
            ...
            <echarts-new :option-data="optionSex" :styles="style1" height="100%" width="100%"></echarts-new>
        </el-card>
      </el-col>
    </el-row>
  </div>
          ...
          series: [
            {
              ...
              itemStyle: {
                ...
                normal:{
                  ...
                  //自定义颜色
                    const colorList = ['#F8C348', '#1991FF', '#40C9D3', '#F94748', '#854FF8'];
        ...
        series: [
            {
              ...
              itemStyle: {
                ...
                normal:{
                  color:function(params) {
                  //自定义颜色
                    const colorList = ['#1890FF', '#EF9C20', '#4BCAD5', '#854FF8', '#F94748',];
                    return colorList[params.dataIndex]
                  }
                }
              },
